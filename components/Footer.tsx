      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-300">
              Unparalleled luxury in women&apos;s and men&apos;s shoes and bags.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#" className="hover:text-gold transition-colors">Products</Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#" className="hover:text-gold transition-colors">Return Policy</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <Mail className="w-4 h-4 mr-2 text-gold" /> info@email.com
              </li>
              <li className="flex items-center">
                <Phone className="w-4 h-4 mr-2 text-gold" /> +1-234-567-890
              </li>
              <li className="flex items-center">
                <MapPin className="w-4 h-4 mr-2 text-gold" /> 123 Luxury Lane, New York, NY 10001
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Luxe Elegance. All rights reserved.
          </p>
          <p className="mt-2 text-sm text-gray-400">
            Crafted with passion for luxury and excellence.
          </p>
        </div>
      </div>
    </footer>
